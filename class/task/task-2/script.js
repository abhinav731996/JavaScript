...
users.map(user => {                   //calculate all skills
...
let uniqSkills = [];
allSkills.forEach(skills => {             // make uniqe lists  
...
let jsKnow = 0;
users.forEach(user => {                     //who know java script 
...
console.log(`Average salary: ${averageSalary}, Highest Salary: ${highestSalary} & lowest salary: ${lowestSalary}`);
